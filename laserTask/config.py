...
class ExperimentConfig:
    ...
    by ``python wizard.py``).  Edit that file — or run the setup wizard —
...
# values live in *config.json* (generated by ``python wizard.py``).
#
# ── How to configure ───────────────────────────────────────────────
#   • python wizard.py          interactive wizard (recommended)
#   • Edit laserTask/config.json directly, then re-run wizard.py
#
# ── What happens on first run ──────────────────────────────────────
#   If config.json doesn't exist, get_config() returns the dataclass
#   defaults above.  Run wizard.py once to generate config.json.
#
# ── Derived fields ─────────────────────────────────────────────────
